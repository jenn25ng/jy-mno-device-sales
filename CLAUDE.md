...
## 6. 본부 9개 (판매 본부 — 표시명 = 리포트 라벨)

수도권 · 부산 · 대구 · 서부 · 중부 · PS&M · 제휴 · 기업사업본부 · TDS
- ⚠️ **마트 org명 ≠ 표시명**. `_HQ_PREFIX`가 접두 매핑: **PS&M=`유통사업부`(53,837), TDS=`MNO AI마케팅`(25,771)**. 나머지는 `수도권마케팅담당`처럼 접두 일치.
- **9개 합 = 383,799**(2026-05). `air서비스본부`(4,253)·`Connectivity사업`·`Product&Brand본부`는 비본부라 제외. (전체 조직 무필터=388,058)
